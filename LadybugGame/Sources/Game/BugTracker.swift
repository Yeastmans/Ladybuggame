...
final class BugTracker: @unchecked Sendable {
    ...
    private func coloredTexture(for bug: BugType, size: CGSize) -> SKTexture {
        ...
        case .sandFly: return TextureGenerator.generateFruitFlyFrames(size: size, color: .brown).first!
        ...
        // Volcano
        case .emberBeetle: return TextureGenerator.biomeCreatureTexture(named: "Ember Beetle", size: size)
        case .ashMoth: return TextureGenerator.biomeCreatureTexture(named: "Ash Moth", size: size)
        case .magmaSnail: return TextureGenerator.biomeCreatureTexture(named: "Magma Snail", size: size)
        ...
        case .lightningBug: return TextureGenerator.biomeCreatureTexture(named: "Lightning Bug", size: size)
        // Swamp
        case .mudCricket: return TextureGenerator.biomeCreatureTexture(named: "Mud Cricket", size: size)
        case .swampFly: return TextureGenerator.biomeCreatureTexture(named: "Swamp Fly", size: size)
        case .leech: return TextureGenerator.biomeCreatureTexture(named: "Leech", size: size)
        case .mosquitoSwarm: return TextureGenerator.biomeCreatureTexture(named: "Mosquito Swarm", size: size)
        case .alligator: return TextureGenerator.biomeCreatureTexture(named: "Alligator", size: size)
        case .swampSnake: return TextureGenerator.biomeCreatureTexture(named: "Swamp Snake", size: size)
        case .bogSpider: return TextureGenerator.biomeCreatureTexture(named: "Bog Spider", size: size)
        // City/Garden
        case .gardenAnt: return TextureGenerator.biomeCreatureTexture(named: "Garden Ant", size: size)
        case .honeybee: return TextureGenerator.biomeCreatureTexture(named: "Honeybee", size: size)
        case .pillBug: return TextureGenerator.biomeCreatureTexture(named: "Pill Bug", size: size)
        case .houseCat: return TextureGenerator.biomeCreatureTexture(named: "House Cat", size: size)
        case .gardenSnake: return TextureGenerator.biomeCreatureTexture(named: "Garden Snake", size: size)
        case .yellowJacket: return TextureGenerator.generateDesertWaspFrames(size: size).first!
        case .gardenSpider: return TextureGenerator.biomeCreatureTexture(named: "Garden Spider", size: size)
        // Ruins
        case .scarab: return TextureGenerator.biomeCreatureTexture(named: "Scarab", size: size)
        case .dustMite: return TextureGenerator.biomeCreatureTexture(named: "Dust Mite", size: size)
        case .templeWorm: return TextureGenerator.biomeCreatureTexture(named: "Temple Worm", size: size)
        case .stoneGuardian: return TextureGenerator.biomeCreatureTexture(named: "Stone Guardian", size: size)
        case .tombSpider: return TextureGenerator.biomeCreatureTexture(named: "Tomb Spider", size: size)
        case .curseWraith: return TextureGenerator.biomeCreatureTexture(named: "Curse Wraith", size: size)
        case .sandViper: return TextureGenerator.biomeCreatureTexture(named: "Sand Viper", size: size)
        // Mushroom
        case .sporeBug: return TextureGenerator.biomeCreatureTexture(named: "Spore Bug", size: size)
        ...
        // Crystal
        case .gemLarva: return TextureGenerator.biomeCreatureTexture(named: "Gem Larva", size: size)
        case .prismFly: return TextureGenerator.biomeCreatureTexture(named: "Prism Fly", size: size)
        case .crystalMite: return TextureGenerator.biomeCreatureTexture(named: "Crystal Mite", size: size)
        case .shardSentinel: return TextureGenerator.biomeCreatureTexture(named: "Shard Sentinel", size: size)
        case .crystalWyrm: return TextureGenerator.biomeCreatureTexture(named: "Crystal Wyrm", size: size)
        case .refractor: return TextureGenerator.biomeCreatureTexture(named: "Refractor", size: size)
        case .geodeRoller: return TextureGenerator.biomeCreatureTexture(named: "Geode Roller", size: size)
        // Space
        case .cosmicDust: return TextureGenerator.biomeCreatureTexture(named: "Cosmic Dust", size: size)
