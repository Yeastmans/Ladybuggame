...
enum Biome: Int, CaseIterable {
    ...
    var skyColor: SKColor {
        ...
        case .cloud: return SKColor(red: 0.94, green: 0.66, blue: 0.80, alpha: 1.0)
    ...
    var groundColor: SKColor {
        ...
        case .cloud: return SKColor(red: 0.96, green: 0.88, blue: 0.93, alpha: 1.0)
    ...
    var dirtColor: SKColor {
        ...
        case .cloud: return SKColor(red: 0.88, green: 0.74, blue: 0.85, alpha: 1.0)
    ...
    var grassLineColor: SKColor {
        ...
        case .cloud: return SKColor(red: 0.92, green: 0.78, blue: 0.88, alpha: 1.0)
